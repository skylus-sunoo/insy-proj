...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new ProjectINSY.java.date.Button();
        cmdTu = new ProjectINSY.java.date.Button();
        cmdWe = new ProjectINSY.java.date.Button();
        cmdTh = new ProjectINSY.java.date.Button();
        cmdFr = new ProjectINSY.java.date.Button();
        cmdSa = new ProjectINSY.java.date.Button();
        cmdSu = new ProjectINSY.java.date.Button();
        cmd1 = new ProjectINSY.java.date.Button();
        cmd2 = new ProjectINSY.java.date.Button();
        cmd3 = new ProjectINSY.java.date.Button();
        cmd4 = new ProjectINSY.java.date.Button();
        cmd5 = new ProjectINSY.java.date.Button();
        cmd6 = new ProjectINSY.java.date.Button();
        cmd7 = new ProjectINSY.java.date.Button();
        cmd8 = new ProjectINSY.java.date.Button();
        cmd9 = new ProjectINSY.java.date.Button();
        cmd10 = new ProjectINSY.java.date.Button();
        cmd11 = new ProjectINSY.java.date.Button();
        cmd12 = new ProjectINSY.java.date.Button();
        cmd13 = new ProjectINSY.java.date.Button();
        cmd14 = new ProjectINSY.java.date.Button();
        cmd15 = new ProjectINSY.java.date.Button();
        cmd16 = new ProjectINSY.java.date.Button();
        cmd17 = new ProjectINSY.java.date.Button();
        cmd18 = new ProjectINSY.java.date.Button();
        cmd19 = new ProjectINSY.java.date.Button();
        cmd20 = new ProjectINSY.java.date.Button();
        cmd21 = new ProjectINSY.java.date.Button();
        cmd22 = new ProjectINSY.java.date.Button();
        cmd23 = new ProjectINSY.java.date.Button();
        cmd24 = new ProjectINSY.java.date.Button();
        cmd25 = new ProjectINSY.java.date.Button();
        cmd26 = new ProjectINSY.java.date.Button();
        cmd27 = new ProjectINSY.java.date.Button();
        cmd28 = new ProjectINSY.java.date.Button();
        cmd29 = new ProjectINSY.java.date.Button();
        cmd30 = new ProjectINSY.java.date.Button();
        cmd31 = new ProjectINSY.java.date.Button();
        cmd32 = new ProjectINSY.java.date.Button();
        cmd33 = new ProjectINSY.java.date.Button();
        cmd34 = new ProjectINSY.java.date.Button();
        cmd35 = new ProjectINSY.java.date.Button();
        cmd36 = new ProjectINSY.java.date.Button();
        cmd37 = new ProjectINSY.java.date.Button();
        cmd38 = new ProjectINSY.java.date.Button();
        cmd39 = new ProjectINSY.java.date.Button();
        cmd40 = new ProjectINSY.java.date.Button();
        cmd41 = new ProjectINSY.java.date.Button();
        cmd42 = new ProjectINSY.java.date.Button();
    ...
    private ProjectINSY.java.date.Button cmd1;
    private ProjectINSY.java.date.Button cmd10;
    private ProjectINSY.java.date.Button cmd11;
    private ProjectINSY.java.date.Button cmd12;
    private ProjectINSY.java.date.Button cmd13;
    private ProjectINSY.java.date.Button cmd14;
    private ProjectINSY.java.date.Button cmd15;
    private ProjectINSY.java.date.Button cmd16;
    private ProjectINSY.java.date.Button cmd17;
    private ProjectINSY.java.date.Button cmd18;
    private ProjectINSY.java.date.Button cmd19;
    private ProjectINSY.java.date.Button cmd2;
    private ProjectINSY.java.date.Button cmd20;
    private ProjectINSY.java.date.Button cmd21;
    private ProjectINSY.java.date.Button cmd22;
    private ProjectINSY.java.date.Button cmd23;
    private ProjectINSY.java.date.Button cmd24;
    private ProjectINSY.java.date.Button cmd25;
    private ProjectINSY.java.date.Button cmd26;
    private ProjectINSY.java.date.Button cmd27;
    private ProjectINSY.java.date.Button cmd28;
    private ProjectINSY.java.date.Button cmd29;
    private ProjectINSY.java.date.Button cmd3;
    private ProjectINSY.java.date.Button cmd30;
    private ProjectINSY.java.date.Button cmd31;
    private ProjectINSY.java.date.Button cmd32;
    private ProjectINSY.java.date.Button cmd33;
    private ProjectINSY.java.date.Button cmd34;
    private ProjectINSY.java.date.Button cmd35;
    private ProjectINSY.java.date.Button cmd36;
    private ProjectINSY.java.date.Button cmd37;
    private ProjectINSY.java.date.Button cmd38;
    private ProjectINSY.java.date.Button cmd39;
    private ProjectINSY.java.date.Button cmd4;
    private ProjectINSY.java.date.Button cmd40;
    private ProjectINSY.java.date.Button cmd41;
    private ProjectINSY.java.date.Button cmd42;
    private ProjectINSY.java.date.Button cmd5;
    private ProjectINSY.java.date.Button cmd6;
    private ProjectINSY.java.date.Button cmd7;
    private ProjectINSY.java.date.Button cmd8;
    private ProjectINSY.java.date.Button cmd9;
    private ProjectINSY.java.date.Button cmdFr;
    private ProjectINSY.java.date.Button cmdMo;
    private ProjectINSY.java.date.Button cmdSa;
    private ProjectINSY.java.date.Button cmdSu;
    private ProjectINSY.java.date.Button cmdTh;
    private ProjectINSY.java.date.Button cmdTu;
    private ProjectINSY.java.date.Button cmdWe;
