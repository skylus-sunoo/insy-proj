...
(59, '2025-07-08 15:47:50'),
(60, '2025-07-08 17:00:17'),
(61, '2025-07-09 07:26:06'),
(62, '2025-07-09 07:27:47'),
(63, '2025-07-09 07:40:40'),
(64, '2025-07-09 07:43:25');
...
('2025-07-08 14:35:50', 'REQUEST', 'ADD', 'Request-3', 'Request-3', '; Name: asfasf; Description: 324; Quantity: 10', 'saf'),
('2025-07-08 15:06:46', 'REPORT', 'ADD', 'SILANG-22-70356', 'SILANG-22-70356', '; Name: Wire Cutter; Description: Multifunctional Automatic Cable Wire Stripper, Crimping and Cutter Pliers; Condition: DAMAGED', ''),
('2025-07-08 15:14:29', 'REPORT', 'ADD', 'SILANG-17-19118', 'SILANG-17-19118', '; Name: White Board; Description: 4x8ft.; Condition: IN MAINTENANCE', ''),
('2025-07-08 15:30:13', 'CATALOG', 'UPDATE', '', '', '; Category Name: Appliances -> Appliancesa', ''),
('2025-07-08 15:32:08', 'CATALOG', 'UPDATE', '', '', '; Category Name: Appliancesa -> Appliances', ''),
('2025-07-08 15:32:36', 'CATALOG', 'UPDATE', '14', '14', '; Category Name: Appliances -> aAppliances', ''),
('2025-07-08 15:33:25', 'CATALOG', 'UPDATE', 'Catalog-C-14', 'Catalog-C-14', '; Category Name: aAppliances -> Appliances', ''),
('2025-07-08 15:34:03', 'CATALOG', 'UPDATE', 'Catalog-C-2', 'Catalog-C-2', '; Category Name: Books and Educational Resources -> Books and Educational Resourcesaa', ''),
('2025-07-08 15:34:14', 'CATALOG', 'UPDATE', 'Catalog-C-2', 'Catalog-C-2', '; Category Name: Books and Educational Resourcesaa -> Books and Educational Resources', ''),
('2025-07-08 15:47:50', 'REQUEST', 'UPDATE', 'Request-3', 'Request-3', '; Status: PENDING -> RECEIVED', 'saf'),
('2025-07-08 15:47:50', 'MANAGEMENT', 'ADD', 'Silang-25-125148', 'Silang-25-125152', '; Name: Helmet; Price: 300; Quantity: 5; DOD: 2025-07-08; Benefactor: saf', 'N/A'),
('2025-07-08 16:27:00', 'CATALOG', 'ADD', 'Catalog-C-16', 'Catalog-C-16', '; Category Name: asa', ''),
('2025-07-08 16:27:18', 'CATALOG', 'UPDATE', 'Catalog-C-16', 'Catalog-C-16', '; Category Name: asa -> asaaa', ''),
('2025-07-08 16:27:22', 'CATALOG', 'DELETE', 'Catalog-C-16', 'Catalog-C-16', '; Category Name: asaaa', ''),
('2025-07-08 16:28:46', 'CATALOG', 'ADD', 'Catalog-C-17', 'Catalog-C-17', '; Category Name: aaa', ''),
('2025-07-08 16:28:50', 'CATALOG', 'DELETE', 'Catalog-C-17', 'Catalog-C-17', '; Category Name: aaa', ''),
('2025-07-08 16:49:58', 'CATALOG', 'ADD', 'Catalog-C-18', 'Catalog-C-18', '; Category Name: gasga', ''),
('2025-07-08 16:50:06', 'CATALOG', 'UPDATE', 'Catalog-C-18', 'Catalog-C-18', '; Category Name: gasga -> gasgaas', ''),
('2025-07-08 16:50:13', 'CATALOG', 'UPDATE', 'Catalog-C-13', 'Catalog-C-13', '; Category Name: Sports Equipment -> aSports Equipment', ''),
('2025-07-08 16:50:18', 'CATALOG', 'UPDATE', 'Catalog-C-13', 'Catalog-C-13', '; Category Name: aSports Equipment -> Sports Equipment', ''),
('2025-07-08 16:50:27', 'CATALOG', 'ADD', 'Catalog-I-18-25', 'Catalog-I-18-25', '; Item Name: saf; Category: gasgaas; UOM: PIECE', ''),
('2025-07-08 16:52:24', 'CATALOG', 'DELETE', 'Catalog-I-18-25', 'Catalog-I-18-25', '; Item Name: saf', ''),
('2025-07-08 16:52:29', 'CATALOG', 'DELETE', 'Catalog-C-18', 'Catalog-C-18', '; Category Name: gasgaas', ''),
('2025-07-08 17:00:17', 'MANAGEMENT', 'ADD', 'Silang-25-25235253', 'Silang-25-25235255', '; Name: Helmet; Price: 325.5; Quantity: 3; DOD: 2025-07-09; Benefactor: N/A', 'N/A'),
('2025-07-08 17:00:41', 'MANAGEMENT', 'DELETE', 'Silang-25-25235253', 'Silang-25-25235255', '', ''),
('2025-07-09 07:20:57', 'MANAGEMENT', 'UPDATE', 'Silang-25-125148', 'Silang-25-125152', '; Description:  -> Danel Dave Barbuco; Benefactor: saf -> Danel Dave Barbuco', 'N/A'),
('2025-07-09 07:22:18', 'MANAGEMENT', 'UPDATE', 'Silang-25-125148', 'Silang-25-125152', '; Description: Danel Dave Barbuco -> ', 'N/A'),
('2025-07-09 07:24:57', 'MANAGEMENT', 'DELETE', 'Silang-25-125148', 'Silang-25-125148', '', ''),
('2025-07-09 07:25:07', 'MANAGEMENT', 'DELETE', 'Silang-25-125149', 'Silang-25-125149', '', ''),
('2025-07-09 07:25:12', 'MANAGEMENT', 'DELETE', 'Silang-25-125150', 'Silang-25-125150', '', ''),
('2025-07-09 07:26:06', 'MANAGEMENT', 'ADD', 'Silang-25-25235256', 'Silang-25-25235258', '; Name: Volley Ball; Price: 250; Quantity: 3; DOD: 2025-07-09; Benefactor: Kenny Guilaran', 'N/A'),
('2025-07-09 07:26:47', 'MANAGEMENT', 'DELETE', 'Silang-25-25235256', 'Silang-25-25235258', '', ''),
('2025-07-09 07:27:47', 'MANAGEMENT', 'ADD', 'Silang-25-25235259', 'Silang-25-25235261', '; Name: VOM; Description: Kenny Guilaran; Price: 850; Quantity: 3; DOD: 2025-07-09; Benefactor: Kenny Guilaran', 'N/A'),
('2025-07-09 07:40:20', 'MANAGEMENT', 'DELETE', 'Silang-25-25235259', 'Silang-25-25235261', '', ''),
('2025-07-09 07:40:40', 'MANAGEMENT', 'ADD', 'Silang-25-25235262', 'Silang-25-25235262', '; Name: VOM; Description: Kenny Guilaran; Price: 850; Quantity: 1; DOD: 2025-07-10; Benefactor: Kenny Guilaran', 'N/A'),
('2025-07-09 07:43:25', 'MANAGEMENT', 'ADD', 'Silang-25-125153', 'Silang-25-125154', '; Name: VOM; Description: Kenny Guilaran; Price: 850; Quantity: 2; DOD: 2025-07-08; Benefactor: Kenny Guilaran', 'N/A'),
('2025-07-09 07:44:22', 'MANAGEMENT', 'UPDATE', 'Silang-25-125153', 'Silang-25-125154', '; Description: Kenny Guilaran -> Kenny Guilarana; Benefactor: Kenny Guilaran -> Kenny Guilarana', 'N/A'),
('2025-07-09 07:45:08', 'MANAGEMENT', 'UPDATE', 'Silang-25-125153', 'Silang-25-125154', '; Description: Kenny Guilarana -> DC; Benefactor: Kenny Guilarana -> Kenny Guilaran', 'N/A'),
('2025-07-09 07:45:14', 'MANAGEMENT', 'UPDATE', 'Silang-25-125153', 'Silang-25-125153', '; Description: DC -> AC', 'N/A'),
('2025-07-09 07:45:25', 'MANAGEMENT', 'UPDATE', 'Silang-25-125153', 'Silang-25-125153', '; Benefactor: Kenny Guilaran -> Kenny Guilarana', 'N/A'),
('2025-07-09 07:45:37', 'MANAGEMENT', 'UPDATE', 'Silang-25-125153', 'Silang-25-125154', '', 'N/A'),
('2025-07-09 07:51:57', 'MANAGEMENT', 'UPDATE', 'Silang-25-125153', 'Silang-25-125154', '; DOD: 2025-07-08 -> 2025-07-03', 'N/A'),
('2025-07-09 08:09:14', 'REPORT', 'ADD', 'SILANG-17-19119', 'SILANG-17-19119', '; Name: White Board; Description: 4x8ft.; Condition: LOST/STOLEN', ''),
('2025-07-09 08:09:21', 'REPORT', 'UPDATE', 'SILANG-17-19119', 'SILANG-17-19119', '; Condition: LOST/STOLEN -> UNSERVICABLE', ''),
('2025-07-09 08:10:08', 'REPORT', 'UPDATE', 'SILANG-17-19119', 'SILANG-17-19119', '; Condition: UNSERVICABLE -> OBSOLETE', ''),
('2025-07-09 08:15:25', 'REPORT', 'DELETE', 'SILANG-17-19119', 'SILANG-17-19119', '; Name: White Board', ''),
('2025-07-09 08:15:36', 'REPORT', 'ADD', 'SILANG-17-19119', 'SILANG-17-19119', '; Name: White Board; Description: 4x8ft.; Condition: LOST/STOLEN', ''),
('2025-07-09 08:15:42', 'REPORT', 'UPDATE', 'SILANG-17-19119', 'SILANG-17-19119', '; Condition: LOST/STOLEN -> UNSERVICABLE', ''),
('2025-07-09 14:01:47', 'MANAGEMENT', 'UPDATE', 'Silang-25-125153', 'Silang-25-125154', '; Benefactor: Kenny Guilarana -> Kenny Guilaran', 'N/A');

-- --------------------------------------------------------

--
-- Table structure for table `tb_item_out`
--

CREATE TABLE `tb_item_out` (
  `out_id` int(11) NOT NULL,
  `out_timestamp` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `out_name` varchar(1024) NOT NULL,
  `out_quantity` int(11) NOT NULL,
  `out_price` float NOT NULL,
  `out_channel` varchar(256) NOT NULL,
  `out_customer` varchar(256) NOT NULL DEFAULT 'N/A'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `tb_item_out`
--

INSERT INTO `tb_item_out` (`out_id`, `out_timestamp`, `out_name`, `out_quantity`, `out_price`, `out_channel`, `out_customer`) VALUES
(1, '2025-07-08 13:47:57', 'Lashes', 2, 100, 'Lazada', 'John'),
(2, '2025-07-08 13:45:15', 'Lashes', 1, 120, 'Shopee', 'N/A'),
(3, '2025-07-09 13:12:43', 'Weigh Sets', 2, 40, 'Lazada', 'Danel Dave Barbuco'),
(4, '2025-07-09 13:12:43', 'Weighing Scale', 2, 40, 'Lazada', 'Danel Dave Barbuco'),
(5, '2025-07-09 13:12:43', 'Water & Coffee Boiler', 2, 40, 'Lazada', 'Danel Dave Barbuco'),
(6, '2025-07-09 13:12:43', 'Waste Basket', 1, 20, 'Lazada', 'Danel Dave Barbuco'),
(7, '2025-07-09 13:16:33', 'Washing Machine', 1, 20, 'Shopee', 'Danel Dave Barbuco'),
(8, '2025-07-09 13:16:33', 'Wall Clock', 2, 40, 'Shopee', 'Danel Dave Barbuco'),
(9, '2025-07-09 13:17:55', 'Whistle', 2, 40, 'Shopee', 'N/A');
...
--
-- Dumping data for table `tb_item_report`
--

INSERT INTO `tb_item_report` (`report_id`, `report_timestamp`, `report_code`, `report_condition`) VALUES
(1, '2025-07-08 15:06:46', 'SILANG-22-70356', 'DAMAGED'),
(2, '2025-07-08 15:14:29', 'SILANG-17-19118', 'IN MAINTENANCE'),
(4, '2025-07-09 08:15:36', 'SILANG-17-19119', 'UNSERVICABLE');
...
(3, '2025-07-08 14:35:50', 'saf', 'asfasf', '324', 10, 'RECEIVED');
...
('2025-07-08 15:47:50', 125151, 'Helmet', 'Security and Safety Equipment', '', 300, '2025-07-08', 'Danel Dave Barbuco', 'Supply Room', 'N/A', 'Silang-25-125151', 59),
('2025-07-08 15:47:50', 125152, 'Helmet', 'Security and Safety Equipment', '', 300, '2025-07-08', 'Danel Dave Barbuco', 'Supply Room', 'N/A', 'Silang-25-125152', 59),
('2025-07-09 07:43:25', 125153, 'VOM', 'Electronics and IT Equipment', 'AC', 850, '2025-07-03', 'Kenny Guilaran', 'Supply Room', 'N/A', 'Silang-25-125153', 64),
('2025-07-09 07:43:25', 125154, 'VOM', 'Electronics and IT Equipment', 'AC', 850, '2025-07-03', 'Kenny Guilaran', 'Supply Room', 'N/A', 'Silang-25-125154', 64);
...
--
-- Indexes for table `tb_item_out`
--
ALTER TABLE `tb_item_out`
...
--
ALTER TABLE `tb_item_batch`
  MODIFY `batch_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `tb_item_out`
--
ALTER TABLE `tb_item_out`
...
--
ALTER TABLE `tb_item_stock`
  MODIFY `stock_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125155;
